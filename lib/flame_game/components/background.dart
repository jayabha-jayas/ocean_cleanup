...
import 'package:ocean_cleanup/level_selection/levels.dart';
...
class Background extends ParallaxComponent {
  ...
  GameLevel level;
  final double speed;
  List<ParallaxData> layers = [];

  @override
  Future<void> onLoad() async {
    layers = [
      //Background images
      // ParallaxImageData('beam.jpg'),
      // ParallaxImageData('ocean.png'),

      // ParallaxImageData('land.png'),
      // ParallaxImageData('corals.png'),
      // ParallaxImageData('corals_new.png'),
      level.number ==1 ? ParallaxImageData('under_ocean.png'):
    ...
    parallax = await game.loadParallax(layers,
