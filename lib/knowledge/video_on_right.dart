...
class VideoOnRightKnowledge extends StatefulWidget {
  ...
  @override
  State<VideoOnRightKnowledge> createState() => _VideoOnRightKnowledgeState();
}

class _VideoOnRightKnowledgeState extends State<VideoOnRightKnowledge> {
